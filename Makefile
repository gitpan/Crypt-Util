# This Makefile is for the Crypt::Util extension to perl.
#
...
#     DIR => []
#     DISTNAME => q[Crypt-Util]
#     NAME => q[Crypt::Util]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Test::Exception=>q[0], Digest=>q[0], Storable=>q[0], Sub::Exporter=>q[0], Class::ACcessor::Fast=>q[0], Test::use::ok=>q[0] }
#     SIGN => q[1]
#     VERSION => q[0.01_01]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Crypt/Util.pm \
	lib/Digest/MultiHash.pm
...
TO_INST_PM = lib/Crypt/.Util.pm.swo \
	lib/Crypt/Util.pm \
	lib/Crypt/Util.pmc \
	lib/Digest/.MultiHash.pm.swp \
	lib/Digest/MultiHash.pm

PM_TO_BLIB = lib/Digest/MultiHash.pm \
	blib/lib/Digest/MultiHash.pm \
	lib/Crypt/Util.pm \
	blib/lib/Crypt/Util.pm \
	lib/Crypt/.Util.pm.swo \
	blib/lib/Crypt/.Util.pm.swo \
	lib/Digest/.MultiHash.pm.swp \
	blib/lib/Digest/.MultiHash.pm.swp \
	lib/Crypt/Util.pmc \
	blib/lib/Crypt/Util.pmc
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Digest/MultiHash.pm $(INST_MAN3DIR)/Digest::MultiHash.$(MAN3EXT) \
	  lib/Crypt/Util.pm $(INST_MAN3DIR)/Crypt::Util.$(MAN3EXT) 
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Digest" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Storable" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Digest/MultiHash.pm blib/lib/Digest/MultiHash.pm \
	  lib/Crypt/Util.pm blib/lib/Crypt/Util.pm \
	  lib/Crypt/.Util.pm.swo blib/lib/Crypt/.Util.pm.swo \
	  lib/Digest/.MultiHash.pm.swp blib/lib/Digest/.MultiHash.pm.swp \
	  lib/Crypt/Util.pmc blib/lib/Crypt/Util.pmc 
